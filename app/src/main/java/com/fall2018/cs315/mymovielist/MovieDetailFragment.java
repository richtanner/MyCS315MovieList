    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (getArguments().containsKey(ARG_ITEM_ID)) {
            ...
            if (thisMovieImageView != null) {
                ...
                thisMovieImageView.setImageResource(getResources().getIdentifier(mItem.getMovieImage(), "drawable", getContext().getPackageName()));
            ...
            fab.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    String link =  mItem.getMovieWeblink();
                    Intent web = new Intent(getContext(), WebViewActivity.class);

                    web.putExtra("URL", link);
                    startActivity(web);
