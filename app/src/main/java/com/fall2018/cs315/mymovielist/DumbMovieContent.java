...
public class DumbMovieContent {
    ...
    // CS315: DO THIS
    // TODO: Create five NEW movie objects here. Complete with images and URLs. DELETE the two existing movies, they are only here as an example *done*
    ...
    private static final String horrorImage = "horror_poster";
    ...
    private static final String sitcomImage = "jerry";
    ...
    private static final String animeImage = "coryinthemanga";
    ...
    private static final String scifiImage = "spaceballs";
    ...
    private static final String superheroImage = "superheroes";
